"""
Training script for CIFAR-10 correlation experiment.

This script trains 5 different network architectures (regimes) on CIFAR-10:
...
if __name__ == "__main__":
    ...
    print(f"\n{'='*60}")
    print("CIFAR-10 Correlation Experiment")
    print(f"{'='*60}")
    print(f"Dataset: CIFAR-10 (3072 -> hidden -> 10)")
    ...
    results_dir = Path(f'output_local/{experiment_dir_name}/cifar-10')
    ...
    stats = run_split_correlation_experiment(
        ...
        n_outputs=10,  # 10 CIFAR-10 classes
    ...
    # Save results
    output_csv = results_dir / 'correlation_experiment_results_CIFAR10.csv'
